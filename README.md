...
| ------- | ---------------------- | ------------------------------------------------------------ | ----------------------------------------------------- |
| Aula 01 | Introdução ao Java     | [Abrir](https://github.com/nayarakiyota/java/tree/main/helloworld) | Primeiros passos, estrutura básica e saída de dados   |
| Aula 02 | Variáveis e Operadores | [Abrir](https://github.com/nayarakiyota/java/tree/main/atividadeVariaveisOperadores) | Variáveis, constantes, `Scanner`, operadores diversos |
| Aula 03 | Condicionais e Lógicos | [Abrir](https://github.com/nayarakiyota/java/tree/main/atividadeLacosCondicionais) | `if/else`, `switch`, operadores relacionais e lógicos |
| Aula 04 | Laços de Repetição     | [Abrir](https://github.com/nayarakiyota/java/tree/main/exerciciosLacosDeRepeticao) | Estruturas `for`, `while` e `do-while`                |
...
1. Clone o repositório [Aulas Java](https://github.com/nayarakiyota/java) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/nayarakiyota/java.git
```
...
Desenvolvido por [**Nayara**](https://github.com/nayarakiyota)
